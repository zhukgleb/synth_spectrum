from RV.bf import load_spectra, interpolate_template, calculate_bf_profile, plot_bf_profile
import numpy as np
...
v_grid = np.linspace(-20, 20, 600)
segment_width = 8
template, observed = load_spectra(template_path, observed_path, wavelength_min, wavelength_max)
